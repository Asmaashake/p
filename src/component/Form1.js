...
export default function Form1() {
  ...
  const questions = [
    ...
    { question: "لدي معرفة باخذ الادوات والعدد الخاصة بالمهنة التعرف على المهنة ", options: ["لا يوجد معرفة او قدرة","ضعيف","جيد","جيد جدا","ممتاز"] },
    ...
    { question: "هل هناك احد من العائلة يعمل في نفس المهنة؟", options: ["نعم","لا"] },
  ];
          ...
          >
            ...
            {step === 0 && (
              <div className="welcome-screen">
                <h2>مرحبًا بك في استبيان التقييم القبلي للمتدرب</h2>
